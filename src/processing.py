...
def filter_by_state(dictionary_list: list[dict[str, Any]], state_value: Any = "EXECUTED") -> list:
...
def sort_by_date(dictionary_list: list[dict[str, Any]], is_reverse: bool = True) -> list:
